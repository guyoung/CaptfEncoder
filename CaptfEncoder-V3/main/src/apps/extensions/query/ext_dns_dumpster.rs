...
impl super::super::IExtensionComponent for Component {
    fn render(&self, grp: &Group) {
        ...
        let mut wgt_executor = WgtExecutor::new(&grp, "Domain", "google.com", "Fetch", &options);
...
impl super::super::IExecutorHandler for Component {
    fn execute(
        ...
        let result = pollster::block_on(query_::dns_dumpster::fetch(input, Some(options.clone())));
